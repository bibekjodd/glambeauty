  ...
  return (
    ...
    >
      ...
      <DialogContent className="flex max-h-screen flex-col md:max-h-[calc(100vh-40px)]">
        ...
        <div className="flex h-full flex-grow flex-col overflow-y-auto px-2">
          <div className="flex h-full flex-col space-y-7 overflow-y-auto px-2 pb-7 scrollbar-hide">
